...
CPU time, I/O, and device activity. Subsystems therefore are often also called
``resource controllers''. Many modern Linux distributions come with cgroups and
many of these standard subsystems enabled. The system's
...
and manipulated from user space in general, as well as discuss a general
framework frequently used for resource management.
...
subsystems have few practical applications, as already discussed above.}.
