...
%\input{course-content-management/motivation}

%\input{course-content-management/key-server}

\input{course-content-management/git-server}

\input{course-content-management/encrypted-git-repositories}

% \input{course-content-management/test-server}
