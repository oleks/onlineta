...
\bibitem[security/LSM (since Linux 3.3)]{security-lsm-since-linux-3.3}
...
\bibitem[cgroups/cgroups.txt (since Linux
3.14)]{cgroups-cgroups-since-linux-3.14}
...
\bibitem[Documentation/cgroups/memory.txt]{documentation-cgroups-memory.txt}

Li Zefan, et al.  \emph{Memory Resource Controller}. Linux Documentation. Since
Linux 3.14. As of December 13, 2013. Retrieved from
\url{https://github.com/torvalds/linux/blob/8173d5a495b5f859d56d8581d0e2ce5c1fab9c33/Documentation/cgroups/memory.txt},
on April 25, 2014.

Archived by WebCite\textsuperscript{\textregistered}\ at
\url{http://www.webcitation.org/6P6Qit62o}.

\bibitem[Documentation/kernel-parameters.txt]{documentation-kernel-parameters.txt}

Linus Torvalds, et al. \emph{CGROUPS}. Linux Documentation. Since Linux 3.14.
As of August 23, 2013. Retrieved from
\url{https://github.com/torvalds/linux/blob/07555ac144bbf45b1751340c6ee75da1f4e5756d/Documentation/kernel-parameters.txt},
on April 25, 2014.

Archived by WebCite\textsuperscript{\textregistered}\ at
\url{http://www.webcitation.org/6P6SxWR32}.

\bibitem[Documentation/cgroups/cpuacct.txt]{documentation-cgroups-cpuacct.txt}

Bharata B. Rao, et al.  \emph{CPU Accounting Controller}. Linux Documentation.
Since Linux 3.1.  As of July 23, 2011. Retrieved from
\url{https://github.com/torvalds/linux/blob/e47f9d84eec63484ae09f8c5b78ef605efa984a0/Documentation/cgroups/cpuacct.txt},
on April 26, 2014.

Archived by WebCite\textsuperscript{\textregistered}\ at
\url{http://www.webcitation.org/6P7nfVIRF}.
